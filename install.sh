...
echo ""
echo "Configuration utility (add more providers, channels, etc.):"
echo "  curl -fsSL https://raw.githubusercontent.com/rsaisankalp/clawdbotElyments/main/configure.sh | bash"
echo ""
